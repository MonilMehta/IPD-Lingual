...
export function AnimatedTestimonials({
  ...
  subtitle = "Don't just take our word for it. See what learners and tourists have to say about our app.",
  badgeText = "Trusted by Linguists",
  testimonials = [],
  autoRotateInterval = 6000,
  trustedCompanies = [],
  trustedCompaniesTitle = "Trusted by Language Learners worldwide",
  className,
